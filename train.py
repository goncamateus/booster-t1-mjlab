...
def main():
    ...
    parser.add_argument("--timesteps", type=int, default=None, help="Ignored (handled by rl_cfg)")
    ...
    if args.test:
        ...
        if not checkpoint:
            ...
            if checkpoint:
                ...
                print(f"Error: No checkpoints found for experiment '{experiment_name}' in logs/rsl_rl/")
                sys.exit(1)
    ...
    try:
        ...
        print("Alternatively, ensure 'train' and 'play' scripts from mjlab are in your PATH.")
